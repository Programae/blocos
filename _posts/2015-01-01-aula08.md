...
## Objetivos
 -  o aprendizado das estruturas de programação: sequências, ciclos (loops), condições  através da produção de figuras geométricas.
...
### Faça você mesmo
Realizar as atividades de 1 a 5 sugeridas na fase 7 (O Artista 2) do curso Introdutório de 20 horas.
...
Realizar a atividade 11 sugerida na fase 7 (O Artista 2) criando diferentes figuras geométricas com diversos lados.
