...
Em seguida, convide um aluno para representar uma personagem do Code.org e outro aluno para ser o programador. O aluno-personagem deve segurar o transferidor mantendo o valor de 0 graus a sua frente, enquanto o programador passa a ele comandos como na estrutura abaixo, variando a direção (direita e esquerda) e o valor em graus. Estimule os dois alunos a se movimentarem, para que fique claro que o valor  medido em cada caso é referente à personagem, e não em relação ao programador. Espera-se que com esse exercício fique mais claro para eles o conceito de referência para o giro. Não havendo transferidor, é interessante desenhar um cículo no chão como a figura acima, mas tendo uma versão normal e a outra invertida (como na figura abaixo) - com as duas versões, fica mais fácil ver a diferença de sentido. Na figura abaixo a linha azul indica a sua posição inicial, enquanto a seta vermelha o sentido o percurso do giro.
