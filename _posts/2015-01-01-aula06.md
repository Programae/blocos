...
Utilizar a apresentação [Sistema de Movimentação no Blockly](/blocos/pdf/Sistemademovimentacao-Blockly.pdf) para entender a forma como o objeto se posiciona e se desloca na área determinada.

Entender o conceito de ponto e grau.

Separar as crianças em equipes.

Se possível, pedir para as crianças trazerem bonequinhos Lego ou similares.
...
Para a construção dessa imagem seguir as orientações do material PPT – Sistema de movimentação.
...
Realizar as atividades de 1 a 10 sugeridas na [fase 5  - O Artista](http://studio.code.org/s/20-hour)
do curso Introdutório de 20 horas.
...
Pedir para os alunos entrarem novamente na [atividade 10 – code.org (O artista)](http://studio.code.org/s/20-hour/stage/5/puzzle/10) e criar um desenho livre colorido.
